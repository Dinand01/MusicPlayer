            ...
            <div className="copy-page">
                ...
                <div className="copy-files-form">
                    ...
                    <div className="flex-2x">
                        <button onClick={() => this.selectFolder("source")} title="The folder to copy files from">
                            {this.state.source ? "Change source" :  "Source"}
                        </button>
                        <p>{this.state.source}</p>
                    </div>
                    <div className="flex-2x">
                        <button onClick={() => this.selectFolder("destination")} title="The folder to copy files to">
                    ...
                    <div className="flex-1x">
                        <button disabled={!this.state.source || !this.state.destination || !this.state.amount} onClick={() => this.copyFiles()} title="Copy the files">
                            Copy
                        </button>
                    </div>
                </div>}
